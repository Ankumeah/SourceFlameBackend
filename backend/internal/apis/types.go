...
func bad_request(err error) (int, map[string]any) {
...
func invalid_user() (int, map[string]any) {
	return http.StatusNotFound, map[string]any{"error": "Invalid user"}
}
func invalid_repo() (int, map[string]any) {
	return http.StatusNotFound, map[string]any{"error": "Invalid repo"}
}
