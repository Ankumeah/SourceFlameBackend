...
func invalid_user() (int, map[string]any) { return http.StatusBadRequest, map[string]any { "error": "Invalid user" } }
func invalid_repo() (int, map[string]any) { return http.StatusBadRequest, map[string]any { "error": "Invalid repo" } }
